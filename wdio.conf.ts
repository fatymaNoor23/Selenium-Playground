...
export const config: Options.Testrunner = {
    ...
    //
    user: "fatima.noor",
    key: "33wohWM6H8o9hRzULFQB8vcay3QE1p26B8MuPke41E3IeNRsfd",
    //
    ...
    //
    specs: [
        './tests/features/seleniumPlayground.feature'
    ],
    // Patterns to exclude.
    exclude: [
    ...
    cucumberOpts: {
        ...
        require: ['./tests/step-definitions/seleniumPlayground.step.ts'],
